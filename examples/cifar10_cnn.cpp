...
int main() {
	...
	for (int epoch = 1; epoch <= maxEpochs; epoch++) {
		...
		double loss = network.Train(loader.trainInputData, loader.trainOutputData, batchSize, 1, optimizer, LossFunction::CrossEntropy(), augmentation); // обучаем в течение одной эпохи
		cout << "loss: " << loss << endl;
