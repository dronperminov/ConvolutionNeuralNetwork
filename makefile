...
all: mnist cifar10 cifar10-resnet vae vae-conv gan dcgan optimizers activations compares losses errors augmentation tests
...
cifar10-resnet:
	$(COMPILER) $(FLAGS) examples/cifar10_resnet.cpp -o examples/cifar10_resnet
