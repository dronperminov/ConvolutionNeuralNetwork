...
AveragePoolingLayer::AveragePoolingLayer(VolumeSize size, int scale) : NetworkLayer(size.width, size.height, size.deep, size.width / scale, size.height / scale, size.deep) {
